...
public class AccessibilityNodeInfoDumper {
     ...
     *
     * @param windowRoots all root accessibility node in multi windows.
     * @param width       The pixel width of current display
     * @param height      The pixel height of current display
     */
    public static void dumpWindowRootsToFile(AccessibilityNodeInfo[] windowRoots,
                                             int width, int height) {
        if (windowRoots == null || windowRoots.length < 1) {
            return;
        }
        ...
        dumpWindowRootsToFile(windowRoots,
     ...
     * @param height      The pixel height of current display
     */
    public static void dumpWindowRootsToFile(AccessibilityNodeInfo[] windowRoots, File dumpFile,
                                             int width, int height) {
        if (windowRoots == null || windowRoots.length < 1) {
            return;
        }
        ...
        try {
            ...
            Log.e(TAG, "failed to dump multi window to file", e);
        }
